...
CREDIT_READINESS= ArticleData(
    ...
    head_image_label="readycredit.png",
    paragraph_photo_label="ready credit-2.png",
...
INVESTING_101 = ArticleData(
    ...
    head_image_label="investor.png",
    paragraph_photo_label="investor-2.png",
...
SPENDING_HABITS= ArticleData(
    ...
    head_image_label="Spending Habits.png",
    paragraph_photo_label="Spending Habits-2.png",
...
EMERGENCY_FUNDS= ArticleData(
    ...
    head_image_label="emergency funds.png",
    paragraph_photo_label="flat tire.png",
